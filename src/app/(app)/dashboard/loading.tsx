 ...
 *
 * The placeholders are the shared `Skeleton` primitive, so this screen and every
 * other loading state share one shimmer treatment.
 */
  ...
  return (
    <div className="space-y-6" aria-busy="true" aria-label="Loading your workspace">
      ...
      <div className="rounded-3xl border border-border/70 bg-card p-6 sm:p-8">
        ...
        <Skeleton className="mb-5 h-6 w-64 max-w-full" />
