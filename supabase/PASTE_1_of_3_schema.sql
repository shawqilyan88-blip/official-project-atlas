-- ##########################################################################
-- MIGRATION 1 of 3 -- Schema (tables, enum, triggers)
-- Paste this FIRST. Creates app_role, profiles, organizations, memberships.
-- Run in Supabase Dashboard -> SQL Editor. Expect: 'Success. No rows returned.'
-- ##########################################################################
